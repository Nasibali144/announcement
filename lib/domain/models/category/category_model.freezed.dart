...
class _$_Category implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, description: $description, createdAt: $createdAt, modifyAt: $modifyAt, imageUrl: $imageUrl, announcements: $announcements)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, createdAt,
      modifyAt, imageUrl, const DeepCollectionEquality().hash(_announcements));
...
abstract class _Category implements Category {
  const factory _Category(
      ...
      final List<String> announcements}) = _$_Category;
